        ...
        <div className="mb-8">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-2">Create a new user account for your platform</p>
            </div>
            <button
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-blue-700 mt-1">
                      The user will be created with a default password: <code className="bg-blue-100 px-1 rounded">password123</code>. 
